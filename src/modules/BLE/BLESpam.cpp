...
void BLESpam::aj_adv(int ble_choice){
  ...
  while(1) {
    if(millis()-timer >900) {
      ...
      switch(ble_choice){
        case 0: // Applejuice
         Serial.println("iOS Spam (" + String(count) + ")");
          this->executeSpam(Apple);
          break;
        case 1: // SwiftPair
        //  displayRedStripe("SwiftPair  (" + String(count) + ")",TFT_WHITE,FGCOLOR);
        Serial.println("SwiftPair Spam (" + String(count) + ")");
          this->executeSpam(Microsoft);
          break;
        case 2: // Samsung
        Serial.println("Samsung Spam (" + String(count) + ")");
       //   displayRedStripe("Samsung  (" + String(count) + ")",TFT_WHITE,FGCOLOR);
          this->executeSpam(Samsung);
          break;
        case 3: // Android
     //    displayRedStripe("Android  (" + String(count) + ")",TFT_WHITE,FGCOLOR);
     Serial.println("Android Spam (" + String(count) + ")");
          this->executeSpam(Google);
          break;
        case 4: // Tutti-frutti
       //   displayRedStripe("Spam All  (" + String(count) + ")",TFT_WHITE,FGCOLOR);
       Serial.println("All Spam (" + String(count) + ")");
          if(mael == 0) this->executeSpam(Google);
          if(mael == 1) this->executeSpam(Samsung);
          if(mael == 2) this->executeSpam(Microsoft);
          if(mael == 3) {
            this->executeSpam(Apple);
            mael = 0;
          }
